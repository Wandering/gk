...
<head>
    <meta charset="UTF-8">
    <title>个人信息</title>
    <link rel="stylesheet" href="styles/personInfo.css"/>
    <style>
...
<div class="header">
    <div class="w1000">
        <a href="">
            <img src="../common/images/logo-min.png" alt="高考360" class="logo fl"/>
        </a>
        ...
        <div class="user-info-list fr">
            <div class="user">
                <img src="../common/images/avatar.png" alt="avatar" class="user-avatar"/>
                <a href="">韩小寒</a>
            </div>
            <ul class="menu hide">
                <li><a href="">个人信息</a></li>
    ...
    <div class="wipe">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="images/personal_banner1.png" alt=""/></div>
                <div class="swiper-slide"><img src="images/personal_banner1.png" alt=""/></div>
                <div class="swiper-slide"><img src="images/personal_banner1.png" alt=""/></div>
            </div>
...
<script src="../common/scripts/swiper.jquery.min.js"></script>
