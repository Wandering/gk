...
<head>
    ...
    <link rel="stylesheet" href="../../dist/before/styles/before.css"/>
</head>
<body>
<div class="header">
    <div class="w1000">
...
<div class="w1000 main-video">
    ...
    <div class="tabs-content">
        <div class="tabs-content-list">
            <ul class="main-exam-list">
                <li class="item active">
                    <a href="">
                     <span class="subject-n"><strong>数学</strong></span>
                     <span class="subject-t">2014年普通高等学校招生全国统一考试x学校第一次数学（理科）模拟考试</span>
                     <span class="subject-d">上传时间：2015-05-15 09:52</span>
                    </a>
                </li>
                <li class="item">
                    <a href="">
