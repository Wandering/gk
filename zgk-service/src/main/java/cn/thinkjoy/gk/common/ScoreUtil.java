...
public class ScoreUtil {
    ...
    public static final long JS_AREA_CODE = 320000;
    ...
    public static final Integer MAJORTYPE_WEN = 1;

    public static final Integer MAJORTYPE_LI = 2;
...
//        map.get
    ...
    public Map<String, Object> getBatchLine(long areaId, int majorType) {
        ...
        rtnMap.put("batchLine", getBatchByArea(areaId,majorType));
