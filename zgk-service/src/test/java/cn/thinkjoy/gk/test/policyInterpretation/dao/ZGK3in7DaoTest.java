...
//    private IAdmissionBatchDAO admissionBatchDAO;
    ...
    public void findTest(){
        ...
        try {
            System.out.println("开始调试getUniversityByArea!");
            Map<String,Object> map = new HashMap<>();
            map.put("areaId","110000");
            map.put("universityName","北京");
            List<Map<String,Object>> result= zgk3in7DAO.getUniversityByArea(map);
            if(result.size()>0){
                System.out.println("getUniversityByArea调试正常!");
            }else {
                System.out.println("getUniversityByArea调试异常!");
            }
        }catch (Exception e){
            System.out.println("getUniversityByArea调试异常!");
            e.printStackTrace();
        ...
        try {
            System.out.println("开始调试getMajorByUniversityId!");
            Map<String,Object> map = new HashMap<>();
            map.put("universityId","10001");
            map.put("majorName","国际政治");
            List<Map<String,Object>> result= zgk3in7DAO.getMajorByUniversityId(map);
            if(result.size()>0){
                System.out.println("getMajorByUniversityId调试正常!");
            }else {
                System.out.println("getMajorByUniversityId调试异常!");
            }
        }catch (Exception e){
            System.out.println("getMajorByUniversityId调试异常!");
            e.printStackTrace();
