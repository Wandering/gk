...
jQuery(".modal").resize(function(){var modal_h=jQuery(".modal").height();var windows_h=jQuery(window).width();if(modal_h>=windows_h){jQuery(this).addClass("modal-overflow modal-overflow2");return;}
  else{jQuery(this).removeClass("modal-overflow modal-overflow2");}});
