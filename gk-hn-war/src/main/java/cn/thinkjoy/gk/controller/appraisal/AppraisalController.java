...
public class AppraisalController extends BaseController {
    ...
    public String schoolTest(@RequestParam(value="m_aggregateScore",required=false) String m_aggregateScore,
        ...
        try {
            ...
            String result = HttpRequestUtil.doGet("http://hn.gaokao360.gkzy114.com/index.php?s=/Restful/CollegeEval/GetEvaluation/m_aggregateScore/"+m_aggregateScore+"/m_university_name/"+m_university_name+"/m_kelei/"+m_kelei);
