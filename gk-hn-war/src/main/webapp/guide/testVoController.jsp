...
<form action="testController/test.do" method="post" id="testForm">
  ...
  <input type="radio" name="batch" value="1">填报指南</p>
  <input type="radio" name="batch" value="2">高考术语</p>
  <input type="radio" name="batch" value="3">录取规则</p>
  <input type="radio" name="batch" value="4">填报技巧</p>
  <input type="radio" name="batch" value="5">志愿讲堂</p>
