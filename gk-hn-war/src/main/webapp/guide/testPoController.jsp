...
<form action="testController/test.do" method="post" id="testForm">
  ...
  <input type="test" name="summary"></p>
  <input type="radio" name="batch" value="13">高考提前录取</p>
  <input type="radio" name="batch" value="14">提前批次</p>
  <input type="radio" name="batch" value="15">一批本科</p>
  <input type="radio" name="batch" value="16">二批本科</p>
  <input type="radio" name="batch" value="17">三批本科</p>
  <input type="radio" name="batch" value="18">高职专科</p>
