...
<div class="content">
    ...
    <div class="w1000">
        ...
        <div class="tip-board">
            ...
            <p>版权：本版权归属湖南省高考360志愿指导平台。未经授权不得拷贝，引用报告中的相关信息。</p>
        </div>
        <table border="1" cellspacing="0">
            <tr class="t-title">
                <th colspan="2">院校</th>
            ...
            <tr class="t-content">
                ...
                <td>
                    ...
                    <p>院校代码:<span>4414</span></p>

                    <p>院校特征：<span></span></p>

                    <p>院校隶属：<span>地方政府所属</span></p>

                    <p>院校类型：<span>财经</span></p>

                    <p>2014最低投档分：<span>563</span>2014最低位次：<span>17283</span></p>

                    <p>2014录取平均分：<span>573</span>2014平均分位次：<span>12234</span></p>
                </td>
                <td>
                    <p>1、经济学</p>
                    <p>2、金融学</p>
                ...
                <td>
                    <p><input type="radio" name="obey" checked/>&nbsp;&nbsp;是</p>
                    <p>(建议服从)</p>
                    <p><input type="radio" name="obey"/>&nbsp;&nbsp;否</p>
                </td>
            </tr>
            <tr class="t-content">
                <td><b>B志愿</b></td>
        ...
        <div class="evaluate-count">
            ...
            <div class="eva-text">
                ...
                生地分数在二本批次还是有较大优势和竞争力地，同理，二本压线生地分数相对于三本，三本压线生相对于高职高专。 </p>

                    <p><strong>我提出的三点建议：</strong></p>
                <p><strong>1.</strong>对于压线考生来说，不要放弃本批次地录用。充分利用高考志愿卡,筛选出合理地高校，志愿高校一定要填满，专业服从调剂，费省会或者热点城市地高
                校，录取的机会大。 </p>
