...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<%=ctx%>/static-expert/src/css/info-management/info-management.css" />
    </head>
    <body>
        ...
        <script src="<%=ctx%>/static-expert/src/js/info-management/info-management.js"></script>
    </body>
</html>
