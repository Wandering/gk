...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (util) {
	    ...
	    $(function () {
	        ...
	        var lqnyyc = __webpack_require__(116);
	        $('#lqnyyc').attr('src',lqnyyc);
	        var yxyc = __webpack_require__(117);
	        $('#yxyc').attr('src',yxyc);

	        var zytb = __webpack_require__(118);
	        $('#zytb').attr('src',zytb);
	        var zypc = __webpack_require__(119);
	        $('#zypc').attr('src',zypc);
	        var gkxt = __webpack_require__(120);
	        $('#gkxt').attr('src',gkxt);
