...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function (util) {
	    ...
	    $(function () {
	        $('#banner-info').prepend(__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"html!../static/user-banner.html\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())));
	        var yxxxImg = __webpack_require__(59);
	        $('#yxxx-img').attr('src',yxxxImg);
	        var zyxxImg = __webpack_require__(60);
	        $('#zyxx-img').attr('src',zyxxImg);
	        var zyxxsImg = __webpack_require__(63);
	        $('#zyxxs-img').attr('src',zyxxsImg);
	        var lqnyyc = __webpack_require__(122);
	        $('#lqnyyc').attr('src',lqnyyc);
	        var yxyc = __webpack_require__(123);
	        $('#yxyc').attr('src',yxyc);

	        var zytb = __webpack_require__(124);
	        $('#zytb').attr('src',zytb);
	        var zypc = __webpack_require__(125);
	        $('#zypc').attr('src',zypc);
	        var gkxt = __webpack_require__(126);
	        $('#gkxt').attr('src',gkxt);
