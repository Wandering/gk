...
//    }
    ...
    public void testQueryInfoByRecordId(){
        String url=host +queryInfoByRecordId_url + "?recordId=325";
        String result = RequestUtils.requestGet(url);
        System.out.println("result = " + result);
    }
    ...
    public void testQueryAllRecordByUserId(){
        String url=host +queryAllRecordByUserId_url + "?userId=2";
        String result = RequestUtils.requestGet(url);
        System.out.println("result = " + result);
    }
    ...
    public void testQueryMajorBySchoolIdAndAreaId(){
        String url=host +queryMajorBySchoolIdAndAreaId_url + "?userId=2&areaId=330000&schoolId=1";
        String result = RequestUtils.requestGet(url);
        System.out.println("result = " + result);
    }
