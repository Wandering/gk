...
//import cn.thinkjoy.gk.domain.ExpertServiceDays;
 ...
 */
@Service
public class ExpertOrderServiceImpl implements IExpertOrderService {

//    @Autowired
//    private IExpertReservationOrderDetailService expertReservationOrderDetailService;
//    @Autowired
...
//        expertOrderExService.queryPageByDataPerm(bizData4Page, "id", SqlOrderEnum.DESC);
        /**
...
//                expertReservationOrderDetailService.updateMap(map);
//            }
//            else
//            {
