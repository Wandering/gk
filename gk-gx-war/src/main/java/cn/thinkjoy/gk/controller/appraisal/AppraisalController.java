...
public class AppraisalController extends BaseController {
    ...
    public String lstest() throws Exception{
        ...
        try {
            String result = HttpRequestUtil.doHttpPost("http://open.lstest.com/default/", params);
    ...
    public String schoolTest(@RequestParam(value="m_aggregateScore",required=false) String m_aggregateScore,
        ...
        try {
            ...
            String result = HttpRequestUtil.doGet("http://gx.gaokao360.gkzy114.com/index.php?s=/Restful/CollegeEval/GetEvaluation/m_aggregateScore/"+m_aggregateScore+"/m_university_name/"+m_university_name+"/m_kelei/"+m_kelei);
    ...
    public String findRanking(@RequestParam(value="m_aggregateScore",required=false) String m_aggregateScore,
        ...
        try {
            ...
            String result = HttpRequestUtil.doGet("http://gx.gaokao360.gkzy114.com/index.php?s=/Restful/CandidateRanking/GetRanking/m_aggregateScore/"+m_aggregateScore);
